    ...
    <section className={styles.contactSection}>
      ...
      <div className={styles.infoContainer}>
        ...
        <ul className={styles.infoList}>
          ...
          <li>
            <MapPin className={styles.icon} /> Zuhdije Žalića 84, Velika Kladuša 77230
          </li>
          <li>
            <Phone className={styles.icon} /> (037) 772 – 002
          </li>
          <li>
            <Smartphone className={styles.icon} /> +(387) 62 – 647 – 943
          </li>
          <li>
            <Mail className={styles.icon} /> esvet.vk@gmail.com
          </li>
          <li className={styles.hours}>
            <Clock className={styles.icon}/> Ponedjeljak – Subota: 08h – 15h (redovne intervencije) <br/> 00h – 24h (hitne intervencije)
          </li>
        </ul>
      </div>
    </section>
